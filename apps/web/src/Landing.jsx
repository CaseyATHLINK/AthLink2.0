      ...
      <header className="hero">
        ...
        <div className="wrap hero-inner">
          ...
          <div className="hero-portals">
            ...
            <button className="pbtn soon" disabled aria-disabled="true">Tennis<span className="pill-soon">Coming soon</span></button>
            <button className="pbtn soon" disabled aria-disabled="true">Triathlon<span className="pill-soon">Coming soon</span></button>
          </div>
        </div>
      </header>
