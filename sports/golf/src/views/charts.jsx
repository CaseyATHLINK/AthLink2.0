    ...
    : (<div style={{padding:"4px 0"}}>
        ...
        {headToHead&&(headToHead.n>0?(
          <div style={{padding:"13px 16px 14px",borderBottom:"1px solid rgba(120,160,210,.16)"}}>
            <div style={{fontSize:10.5,fontWeight:800,letterSpacing:".08em",textTransform:"uppercase",color:"#7fa0c0",marginBottom:4,display:"flex",alignItems:"center",gap:6}}>Head-to-head<InfoHint text="Your rivals are the athletes you've competed against most in the selected years — ranked by how often you meet and how close your finishes are. Bigger, closer nodes compete against you more often. Events you played together in don't count toward this record."/></div>
